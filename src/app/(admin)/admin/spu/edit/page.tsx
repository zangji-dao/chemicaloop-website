            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled={!!spuId}
                  placeholder="50-00-0"
                  className="w-full bg-slate-900/50 border border-slate-700/80 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/60 disabled:opacity-50"
                />
              </div>
              {/* HS编码 */}
              <div>
                ...
                <input
                  ...
                  placeholder="290241"
                  className="w-full bg-slate-900/50 border border-slate-700/80 rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/60"
                />
              </div>
              {/* 状态 */}
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-900/50 border border-slate-700/80 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/60"
                >
                  ...
                  {hsCodeCountries.map((country) => (
                    <div key={country.code} className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="flex-1 bg-slate-900/50 border border-slate-700/80 rounded-lg px-3 py-2 text-xs font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/60"
                      />
                    </div>
                  ))}
                </div>
          ...
          <div className="mb-8">
            ...
            <div className="mb-3">
              ...
              <textarea
                ...
                className="w-full bg-slate-900/50 border border-slate-700/80 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/60 overflow-hidden"
                style={{ height: 'auto' }}
              />
            </div>
            <div className="grid grid-cols-3 gap-4">
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-900/50 border border-slate-700/80 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/60"
              />
              <button
                type="button"
