...
async function proxyToBackend(request: NextRequest, userId: string): Promise<NextResponse> {
  ...
  // 前端 /api/www/contact-requests → 后端 /api/www/contact-requests
...
// PATCH /api/www/contact-requests
...
// DELETE /api/www/contact-requests
